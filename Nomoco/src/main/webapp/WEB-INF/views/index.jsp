	...
	<section class="container py-5">
		...
		<div class="row">
			<div class="col-12 col-md-4 p-5 mt-3">
				<a href="#"><img
					src="${pageContext.request.contextPath }/resources/img/category_img_01.jpg"
			...
			<div class="col-12 col-md-4 p-5 mt-3">
				<a href="#"><img
					src="${pageContext.request.contextPath }/resources/img/category_img_02.jpg"
					class="rounded-circle img-fluid border"></a>
			...
			<div class="col-12 col-md-4 p-5 mt-3">
				<a href="#"><img
					src="${pageContext.request.contextPath }/resources/img/category_img_03.jpg"
					class="rounded-circle img-fluid border"></a>
		...
		<div class="container py-5">
			...
			<div class="row">
				<div class="col-12 col-md-4 mb-4">
					<div class="card h-100">
						<a href="shop-single.html"> <img
							src="${pageContext.request.contextPath }/resources/img/feature_prod_01.jpg"
				...
				<div class="col-12 col-md-4 mb-4">
					<div class="card h-100">
						<a href="shop-single.html"> <img
							src="${pageContext.request.contextPath }/resources/img/feature_prod_02.jpg"
							class="card-img-top" alt="...">
						</a>
						<div class="card-body">
							<ul class="list-unstyled d-flex justify-content-between">
				...
				<div class="col-12 col-md-4 mb-4">
					<div class="card h-100">
						<a href="shop-single.html"> <img
							src="${pageContext.request.contextPath }/resources/img/feature_prod_03.jpg"
							class="card-img-top" alt="...">
						</a>
						<div class="card-body">
							<ul class="list-unstyled d-flex justify-content-between">
