            ...
            <form class="col-md-9 m-auto" action="${pageContext.request.contextPath }/board/register" method="post" role="form">
                <div class="row">
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control mt-1" id="id" name="id" placeholder="${id}"  readonly="readonly">
                    </div>
                    <div class="form-group col-md-6 mb-3">
                        <label for="inputname">주소(IP)</label>
                        <input type="text" class="form-control mt-1" id="ip" name="ip" placeholder="${ip}"  readonly="readonly">
                    </div>
                </div>
                <div class="mb-3">
