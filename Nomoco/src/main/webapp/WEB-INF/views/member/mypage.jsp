        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 pb-5"><a href = "#">
                 <a
						...
						href="mailto:info@company.com"><div class="h-100 py-5 services-icon-wap shadow" style="border: solid gray; box-shadow: 5px 5px 5px 5px gray; border-radius: 10px;">
                    <div class="h1 text-success text-center"><i class="fa fa-user"></i></div>
                    <h2 class="h5 mt-4 text-center"><i class="fa fa-envelope mx-2" style="color: blue"></i><span style="color: black;">문의하기 <br>shjeon510@gmail.com</span></a></h2>
						</a>
                </div>
            </div></a>
        </div>
